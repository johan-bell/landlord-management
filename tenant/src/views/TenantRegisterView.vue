    ...
    <div class="mx-auto w-full max-w-[480px]">
      ...
      <div class="tenant-card p-6 sm:p-8">
        ...
        <p class="mt-2 text-center text-sm text-slate-600">
          Pick one path — your landlord may have told you which to use.
        </p>
        ...
        >
          Enter the <strong class="text-slate-900">organization ID</strong> or
          <strong class="text-slate-900">slug</strong> from your landlord. After
          you register, they assign your unit and approve access.
        </p>
        <p
        ...
        >
          Your landlord created a profile for you. Use the renter ID they shared
          — <strong class="text-slate-900">your email must match</strong> that
          profile.
        </p>
        <p
          v-else
        ...
        >
          Paste the token from the invite link your landlord sent (or open the
          link on this device first).
        </p>
        ...
        >
          ...
          <p v-if="preview.emailHint" class="mt-1 text-xs text-slate-600">
        ...
        <form class="space-y-4" @submit.prevent="submit">
          <template v-if="registrationMode === 'org'">
            ...
            <label class="block">
              <span class="text-sm font-medium text-slate-700"
                >Phone
                <span class="font-normal text-slate-400">(optional)</span></span
              >
              <input
                v-model="phone"
                type="tel"
