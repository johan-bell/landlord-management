...
const confirmDeleteTarget = ref<Property | null>(null);
...
async function doDelete() {
    const p = confirmDeleteTarget.value;
    if (!p) return;
    try {
    ...
    <div>
        ...
        <template v-else>
            ...
            <div
                ...
                class="rounded-2xl border border-dashed border-slate-200 bg-linear-to-b from-white to-slate-50/80 py-20 text-center"
            >
                <div
                    ...
                    >
                        ...
                        <ul class="mt-2 space-y-2">
                            ...
                            >
                                ...
                                <span
                                    class="shrink-0 font-medium tabular-nums text-slate-900"
                                    >{{
        ...
        <ConfirmDialog
            ...
            :message="`Delete &quot;${confirmDeleteTarget?.name}&quot; and all its units? This cannot be undone.`"
