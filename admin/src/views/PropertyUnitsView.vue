...
async function saveEdit() {
    ...
    try {
        await api(
            orgApi(
                `/properties/${propertyId.value}/units/${editingUnit.value.id}`,
            ),
            {
                method: 'PATCH',
                body: JSON.stringify({
                    ...
                    >
                        ...
                        <tbody class="divide-y divide-slate-100">
                            ...
                            >
                                ...
                                <td
                                    class="px-4 py-3 tabular-nums text-slate-700"
                                >
                    ...
                    >
                        ...
                        <div class="mt-5 border-t border-slate-100 pt-4">
                            ...
                            <p class="mt-1 text-xs text-slate-500">
                                Prepaid meters are managed outside this app.
                                Choose metered only if you bill by consumption
                                (per kWh).
                            </p>
                            <select
                                v-model="newElec"
                            ...
                            >
                                ...
                                <option value="METERED_KWH">
                                    Metered — price per kWh
                                </option>
                            </select>
                            <label
                                v-if="newElec === 'METERED_KWH'"
                                class="mt-2 block"
                            >
                                <span class="text-sm font-medium text-slate-700"
                                    >Price per kWh</span
                        ...
                        <div class="mt-5 border-t border-slate-100 pt-4">
                            ...
                            >
                                ...
                                <option value="METERED_M3">
                                    Metered — price per m³
                                </option>
                            </select>
                            <label
                                v-if="newWater === 'METERED_M3'"
                                class="mt-2 block"
                            >
                                <span class="text-sm font-medium text-slate-700"
                                    >Price per m³</span
                ...
                >
                    ...
                    >
                        ...
                        <div class="mt-5 border-t border-slate-100 pt-4">
                            ...
                            <p class="mt-1 text-xs text-slate-500">
                                Prepaid meters are managed outside this app.
                                Metered = bill per kWh from readings.
                            </p>
                            <select
                                v-model="editElec"
                                class="mt-2 w-full rounded-xl border border-slate-200 px-3 py-2 text-sm"
                        ...
                        <div class="mt-6 flex justify-end gap-2">
                            ...
                            <button
                                ...
                                class="rounded-xl bg-emerald-600 px-4 py-2 text-sm font-semibold text-white disabled:opacity-50"
                                :disabled="
                                    saving || !editLabel.trim() || !editRent
                                "
                                @click="saveEdit"
                            >
                                {{ saving ? 'Saving…' : 'Save' }}
